...
<center>
    ...
    <tr>
		<td><br>A thunderstorm is a type of storm that generates
	...
	rapid, upward motion in the atmosphere.<br></td>

</tr>
  <th style="text-align:center"><font size="5"><br>Earthquake</font></th>  </tr>
  <tr>  <td><br>An earthquake (or quakes, tremors) is shaking of the surface
...
of energy in the Earth's crust.<br></td>
  </tr>

  <tr>
    <th style="text-align:center"><font size="5"><br>Floods</font></th>  </tr>
  <tr>  <td><br>A flood is an overflow of water that submerges land that is usually dry.
...
the word may also be applied to the inflow of the tide.<br></td>
  </tr>

  <tr>
    <th style="text-align:center"><font size="5"><br>Landslides</font></th>  </tr>
  <tr>  <td><br>When earthquakes occur on areas with steep slopes, many times
...
completely saturated by heavy rainfall many times landslides can occur.<br></td>
  </tr>

  <tr>
      <th style="text-align:center"><font size="5"><br>Fires</font></th>  </tr>
  <tr>  <td><br>The dominant color in a flame changes with temperature.
...
yellow region, the color changes to orange.<br></td>
  </tr>

  <tr>
      <th style="text-align:center"><font size="5"><br>Road Accidents</font></th>  </tr>
  <tr>  <td><br>Accident is an undesired or unintended happening.
	Inevitable accident falls within the concept of ACT OF GOD OR
	DAMNUM FATALE OR AN Unfortunate harmful event, event without
	apparent cause unexpected occurring.<br></td>
  </tr>
</center>
</body>
</html>
